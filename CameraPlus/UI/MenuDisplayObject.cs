...
namespace CameraPlus.UI
{
    internal class MenuDisplayObject
    {
        internal void DiplayMenu(CameraPlusBehaviour parentBehaviour,ContextMenu contextMenu, Vector2 menuPos)
        {
            ...
            if (GUI.Button(new Rect(menuPos.x + 5, menuPos.y + 45, 70, 25), new GUIContent("Enable"), parentBehaviour.Config.cameraExtensions.firstPersonCameraForceUpRight ? contextMenu.CustomEnableStyle : contextMenu.CustomDisableStyle))
            {
                parentBehaviour.Config.cameraExtensions.firstPersonCameraForceUpRight = true;
                parentBehaviour.Config.Save();
            }
            if (GUI.Button(new Rect(menuPos.x + 75, menuPos.y + 45, 70, 25), new GUIContent("Disable"), !parentBehaviour.Config.cameraExtensions.firstPersonCameraForceUpRight ? contextMenu.CustomEnableStyle : contextMenu.CustomDisableStyle))
            {
            ...
            if (GUI.Button(new Rect(menuPos.x + 155, menuPos.y + 45, 70, 25), new GUIContent("Enable"), parentBehaviour.Config.cameraExtensions.followNoodlePlayerTrack ? contextMenu.CustomEnableStyle : contextMenu.CustomDisableStyle))
            {
            ...
            if (parentBehaviour.Config.PreviewCamera)
            {
                ...
                if (GUI.Button(new Rect(menuPos.x + 155, menuPos.y + 90, 70, 25), new GUIContent("VR Only"), parentBehaviour.Config.PreviewCameraVROnly ? contextMenu.CustomEnableStyle : contextMenu.CustomDisableStyle))
                {
                    parentBehaviour.Config.PreviewCameraVROnly = true;
                    parentBehaviour.Config.Save();
                }
                if (GUI.Button(new Rect(menuPos.x + 225, menuPos.y + 90, 70, 25), new GUIContent("DisplayAll"), !parentBehaviour.Config.PreviewCameraVROnly ? contextMenu.CustomEnableStyle : contextMenu.CustomDisableStyle))
                {
            ...
            if (GUI.Button(new Rect(menuPos.x + 150, menuPos.y + 220, 75, 20), new GUIContent("Enable"), !parentBehaviour.Config.cameraExtensions.dontDrawDesktop ? contextMenu.CustomEnableStyle : contextMenu.CustomDisableStyle))
            {
                parentBehaviour.Config.cameraExtensions.dontDrawDesktop = false;
                parentBehaviour.Config.Save();
            }
            if (GUI.Button(new Rect(menuPos.x + 225, menuPos.y + 220, 75, 20), new GUIContent("Disable"), parentBehaviour.Config.cameraExtensions.dontDrawDesktop ? contextMenu.CustomEnableStyle : contextMenu.CustomDisableStyle))
            {
            ...
            if (GUI.Button(new Rect(menuPos.x + 0, menuPos.y + 220, 75, 20), new GUIContent("Enable"), parentBehaviour.Config.cameraExtensions.previewCameraMirrorMode ? contextMenu.CustomEnableStyle : contextMenu.CustomDisableStyle))
            {
                parentBehaviour.Config.cameraExtensions.previewCameraMirrorMode = true;
                parentBehaviour._quad.SetCameraQuadPosition(PluginConfig.Instance.CameraQuadPosition, PluginConfig.Instance.CameraCubeSize);
                parentBehaviour.Config.Save();
            }
            if (GUI.Button(new Rect(menuPos.x + 75, menuPos.y + 220, 75, 20), new GUIContent("Disable"), !parentBehaviour.Config.cameraExtensions.previewCameraMirrorMode ? contextMenu.CustomEnableStyle : contextMenu.CustomDisableStyle))
            {
            ...
            if (GUI.Button(new Rect(menuPos.x + 5, menuPos.y + 260, 95, 25), new GUIContent("Link InGame"), parentBehaviour.Config.layerSetting.debris == Configuration.DebriVisibility.Link ? contextMenu.CustomEnableStyle : contextMenu.CustomDisableStyle))
            {
                parentBehaviour.Config.layerSetting.debris = Configuration.DebriVisibility.Link;
                parentBehaviour.Config.Save();
            }
            if (GUI.Button(new Rect(menuPos.x + 105, menuPos.y + 260, 95, 25), new GUIContent("Forced Display"), parentBehaviour.Config.layerSetting.debris == Configuration.DebriVisibility.Visible ? contextMenu.CustomEnableStyle : contextMenu.CustomDisableStyle))
            {
                parentBehaviour.Config.layerSetting.debris = Configuration.DebriVisibility.Visible;
                parentBehaviour.Config.Save();
            }

            if (GUI.Button(new Rect(menuPos.x + 205, menuPos.y + 260, 95, 25), new GUIContent("Forced Hide"), parentBehaviour.Config.layerSetting.debris == Configuration.DebriVisibility.Hidden ? contextMenu.CustomEnableStyle : contextMenu.CustomDisableStyle))
            {
            ...
            if (GUI.Button(new Rect(menuPos.x + 5, menuPos.y + 305, 70, 25), new GUIContent("Display"), parentBehaviour.Config.layerSetting.ui ? contextMenu.CustomEnableStyle : contextMenu.CustomDisableStyle))
            {
                parentBehaviour.Config.layerSetting.ui = true;
                parentBehaviour.Config.Save();
            }
            if (GUI.Button(new Rect(menuPos.x + 75, menuPos.y + 305, 70, 25), new GUIContent("Hide"), !parentBehaviour.Config.layerSetting.ui ? contextMenu.CustomEnableStyle : contextMenu.CustomDisableStyle))
            {
            ...
            if (GUI.Button(new Rect(menuPos.x + 155, menuPos.y + 305, 70, 25), new GUIContent("Display"), parentBehaviour.Config.layerSetting.avatar ? contextMenu.CustomEnableStyle : contextMenu.CustomDisableStyle))
            {
                parentBehaviour.Config.layerSetting.avatar = true;
                parentBehaviour.Config.Save();
            }
            if (GUI.Button(new Rect(menuPos.x + 225, menuPos.y + 305, 70, 25), new GUIContent("Hide"), !parentBehaviour.Config.layerSetting.avatar ? contextMenu.CustomEnableStyle : contextMenu.CustomDisableStyle))
            {
            ...
            if (GUI.Button(new Rect(menuPos.x + 5, menuPos.y + 350, 70, 25), new GUIContent("Display"), parentBehaviour.Config.layerSetting.saber ? contextMenu.CustomEnableStyle : contextMenu.CustomDisableStyle))
            {
                parentBehaviour.Config.layerSetting.saber = true;
                parentBehaviour.Config.Save();
            }
            if (GUI.Button(new Rect(menuPos.x + 75, menuPos.y + 350, 70, 25), new GUIContent("Hide"), !parentBehaviour.Config.layerSetting.saber ? contextMenu.CustomEnableStyle : contextMenu.CustomDisableStyle))
            {
            ...
            if (GUI.Button(new Rect(menuPos.x + 155, menuPos.y + 350, 70, 25), new GUIContent("Display"), parentBehaviour.Config.layerSetting.notes ? contextMenu.CustomEnableStyle : contextMenu.CustomDisableStyle))
            {
                parentBehaviour.Config.layerSetting.notes = true;
                parentBehaviour.Config.Save();
            }
            if (GUI.Button(new Rect(menuPos.x + 225, menuPos.y + 350, 70, 25), new GUIContent("Hide"), !parentBehaviour.Config.layerSetting.notes ? contextMenu.CustomEnableStyle : contextMenu.CustomDisableStyle))
            {
            ...
            if (GUI.Button(new Rect(menuPos.x + 5, menuPos.y + 395, 70, 25), new GUIContent("Display"), parentBehaviour.Config.layerSetting.wall ? contextMenu.CustomEnableStyle : contextMenu.CustomDisableStyle))
            {
                parentBehaviour.Config.layerSetting.wall = true;
                parentBehaviour.Config.Save();
            }
            if (GUI.Button(new Rect(menuPos.x + 75, menuPos.y + 395, 70, 25), new GUIContent("Trans"), !parentBehaviour.Config.layerSetting.wall ? contextMenu.CustomEnableStyle : contextMenu.CustomDisableStyle))
            {
            ...
            if (GUI.Button(new Rect(menuPos.x + 155, menuPos.y + 395, 70, 25), new GUIContent("Enable"), parentBehaviour.Config.layerSetting.wallFrame ? contextMenu.CustomEnableStyle : contextMenu.CustomDisableStyle))
            {
                parentBehaviour.Config.layerSetting.wallFrame = true;
                parentBehaviour.Config.Save();
            }
            if (GUI.Button(new Rect(menuPos.x + 225, menuPos.y + 395, 70, 25), new GUIContent("Disable"), !parentBehaviour.Config.layerSetting.wallFrame ? contextMenu.CustomEnableStyle : contextMenu.CustomDisableStyle))
            {
